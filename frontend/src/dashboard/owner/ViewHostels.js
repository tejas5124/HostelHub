            ...
            <>
              ...
              <div className="search-container">
                <div className="search-filters">
                  <input name="name" type="text" placeholder="🔍 Search by name..." value={searchFilters.name} onChange={handleSearchChange} className="search-input" />
                  <input name="address" type="text" placeholder="📍 Search by address..." value={searchFilters.address} onChange={handleSearchChange} className="search-input" />
                  <select name="gender" value={searchFilters.gender} onChange={handleSearchChange} className="search-select">
                    <option value="">All Genders</option>
                    <option value="boys">Boys</option>
                    <option value="girls">Girls</option>
                  </select>
                  <input name="rent" type="number" placeholder="💰 Max Rent" value={searchFilters.rent} onChange={handleSearchChange} className="search-input" />
                  ...
                  <tbody>
                    {filteredHostels.map((hostel, index) => (
                      <tr key={hostel.hostel_id}>
                        ...
                        <td>
                          <button onClick={() => setSelectedHostel(hostel)}>View</button>
